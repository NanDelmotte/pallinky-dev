...
import { View, TextInput, TouchableOpacity, FlatList, Image, StyleSheet, Modal, ActivityIndicator } from 'react-native';
...
const UNSPLASH_ACCESS_KEY = 'uN_q_mAiD9e2cE0DItRvZpSBTp4nmWiYv_BeEh6NcKk'; // <-- Put your key here

export default function ImageSearchModal({ visible, onClose, onSelect }: ImageSearchModalProps) {
