...
export default function HomeScreen() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const [hostedEventsRes, invitesRes, myRsvpsRes, circlesRes, deviceContactsRes] =
        await Promise.all([
            ...
            {brewingSignals.some(
              ...
              <>
                <FeedSectionHeader
                  ...
                  subtitle="Don't worry, they said you could peek"
                  theme={theme}
                />
                <FriendsActivities
                  data={data}
...
function ReconnectSection({
  ...
  const suggestionSignals = signals.filter(
    (s) => s.type === 'suggested_connection'
  );
  ...
  return (
    <>
      <FeedSectionHeader
        title="Reconnect"
        subtitle="People you may want to pull back into orbit."
        theme={theme}
      />
