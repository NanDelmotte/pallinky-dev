...
const QUICK_STARTS: QuickStart[] = [
  { label: 'Quick Coffee', icon: 'cafe-outline', route: '/create/vibe', params: { prefill_title: 'Coffee?', prefill_desc: 'Anyone up for coffee?' } },
  { label: 'Trendy Dinner', icon: 'restaurant-outline', route: '/create/formal', params: { prefill_title: 'Dinner', prefill_desc: 'Come join for dinner.' } },
  { label: 'Casual Drinks', icon: 'wine-outline', route: '/create/vibe', params: { prefill_title: 'Drinks?', prefill_desc: 'Thinking about drinks. Who’s in?' } },
  { label: 'Take a Walk', icon: 'walk-outline', route: '/create/vibe', params: { prefill_title: 'Walk?', prefill_desc: 'Fancy a walk?' } },
  { label: 'Visit a Museum', icon: 'business-outline', route: '/create/vibe', params: { prefill_title: 'Museum?', prefill_desc: 'Anyone up for a museum visit?' } },
