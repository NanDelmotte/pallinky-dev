...
export default function DesignStudioScreen() {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {step === 1 ? (
        <ScrollView contentContainerStyle={styles.stepOneContainer}>
          ...
          <View style={styles.stepOneActions}>
            <TouchableOpacity
              style={styles.uploadOnlyBtn}
              onPress={() => setShowSearch(true)}
            >
              <Ionicons name="search-outline" size={18} color="#6b7280" />
              <StyledText style={styles.uploadOnlyText}>Choose Cover Image</StyledText>
            </TouchableOpacity>
            ...
            >
              {uploadingCover ? (
                <ActivityIndicator color="#43691b" size="small" />
              ) : (
                <>
                  <Ionicons name="cloud-upload-outline" size={18} color="#6b7280" />
                  <StyledText style={styles.uploadOnlyText}>Upload Your Own Photo</StyledText>
                </>
              )}
            </TouchableOpacity>
          </View>
