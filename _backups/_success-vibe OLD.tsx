...
<View style={[styles.popCard, { borderColor: '#25D366', marginTop: 15 }]}>
  <View style={styles.popHeader}>
    <Ionicons name="people" size={18} color="#25D366" />
    <StyledText style={styles.popTitle}>Invite your Circles</StyledText>
  </View>
  <StyledText style={styles.popSub}>Instantly notify your groups without leaving the app.</StyledText>
  
  <TouchableOpacity 
    style={[styles.popBtn, { backgroundColor: '#25D366' }]} 
    onPress={() => router.push({
      pathname: '/circle-share-picker', // Adjust path to your actual file location
      params: { slug, title }
    })}
  >
    <StyledText style={styles.popBtnText}>Select Circles</StyledText>
